...
def init_logging(config):
    ...
    logger = AGILib.agilogger.initialize_agilogger(logfile_name="staticpagegenerator.log", logfile_folder=log_directory, list_log_handler=['file', 'stream'], archive=True, logger_name="sgpLogger")        
    return logger
